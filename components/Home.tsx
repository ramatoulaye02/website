...
const BubbleJumpGame: React.FC = () => {
  ...
  const handleJump = useCallback(() => {
    ...
    if (gameState.current.jumpCount < 2) {
      ...
      createParticles(150, gameState.current.bubbleY + BUBBLE_RADIUS, '#fad4e7');
    }
...
const Home: React.FC = () => {
  ...
  const socials = [
    ...
    { name: 'GitHub', url: 'https://github.com/ramatoulaye02', icon: (
      <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
    ...
    { name: 'LinkedIn', url: 'https://linkedin.com/in/ramatoulayebalde', icon: (
      <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
